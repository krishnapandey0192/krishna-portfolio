      ...
      <div className="py-6 flex flex-col md:flex-row items-center md:items-start justify-between gap-6">
        ...
        >
          <p className="text-textWhite p-4 text-lg sm:text-xl sm:leading-7">
            ...
            <br />
            I have experience working with C, C++, JavaScript, TypeScript,
            Python, HTML, CSS, React.js, Next.js, Node.js, Express.js, MongoDB,
              ...
              <ul className="list-disc pl-2 flex flex-col gap-4">
                ...
                >
                  <h5 className="text-2xl font-[600]">
                    ...
                    <span className="text-base font-[500]">- Umpteen</span>
                  </h5>
                  <div className="mt-2 flex gap-4 items-center">
                    <div className="w-[15px] h-[2px] bg-textWhite "></div>
                    <span>
                      <p>
                        Developing a react.js-based platform for vehicle service
                        bookings dashboard serves as an admin and service
                        provider interface, enabling effective management of
                        customer service requests, vehicle service records, and
                        operational processes. Utilizing technologies such as
                        React.js, Typescript, Tailwind CSS, Material UI, Redux
                        and hooks for seamless functionality.
                      </p>
                    </span>
                  </div>
                  <div className="ml-6 mt-1 text-gray-500 font-medium flex items-center justify-between max-w-[95%]">
                    <span className="">Nov 2022 - Apr 2023</span>
                    <span className="">Bhopal</span>
                  </div>
                </motion.li>
                <motion.li
                  initial={{ opacity: 0 }}
                ...
                >
                  <h5 className="text-2xl font-[600]">
                    ...
                    <span className="text-base font-[500]">- nanostack</span>
                  </h5>
                  <div className="mt-2 flex gap-4 items-center">
                    <div className="w-[15px] h-[2px] bg-textWhite "></div>
                    <span>
                      <p>
                        Working as a MERN Stack Developer in nanostack,
                        Developing Booksica dashboard is a powerful, data-driven
                        platform built to manage the book sales, inventory, and
                        customer interactions of an online bookstore. As a core
                        part of the system, the dashboard provides intuitive
                        controls for admins to manage product listings, view
                        detailed analytics, and process customer orders, all in
                        a seamless, real-time interface.Utilizing technologies
                        such as React.js, Typescript, Tailwind CSS, Material UI,
                        Redux and hooks for seamless functionality.
                      </p>
                    </span>
                  </div>
                  <div className="ml-6 mt-1 text-gray-500 font-medium flex items-center justify-between max-w-[95%]">
                    <span className="">jun 2023 - Present</span>
                    <span className="">Bhopal</span>
                  </div>
                </motion.li>
              </ul>
